      ...
      <body className="min-w-[18.75rem] flex flex-col lg:flex-row">
        ...
        <div className=" lg:w-1/3 lg:h-screen bg-neutral-200 lg:pt-24 overflow-hidden">
          <div className="flex absolute items-center right-20 lg:right-56 gap-5">
            ...
            <p
              onClick={logoutUser}
              className="font-bold text-xs leading-4 text-secondary cursor-pointer lg:relative lg:top-5 lg:right-12 border-l-2 pl-5 border-neutral-400 z-10 hidden lg:block"
            >
              Exit
            </p>
          </div>
          <div className="lg:mt-52 px-8 sm:px-20 lg:w-2/3 flex flex-col md:flex-row justify-around py-24 lg:py-0 lg:flex-col">
